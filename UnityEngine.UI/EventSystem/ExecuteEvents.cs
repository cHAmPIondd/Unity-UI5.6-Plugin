...
namespace UnityEngine.EventSystems
{
    public static class ExecuteEvents
    {
        ...
        /// <summary>
        /// 各个事件接口的响应方式,统一为EventFunction<T>委托,T为事件接口
        /// </summary>
        ...
        /// 在root物体向上搜索，找到一个能接收T监听事件的物体执行监听事件并返回该物体
        /// </summary>
        ...
        /// 在游戏对象向上搜索T事件，找出哪个对象将实际接收T事件并返回。
        /// </summary>
