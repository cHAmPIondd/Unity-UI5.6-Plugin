...
namespace UnityEngine.UI
{
        ...
        ICanvasElement
    {
        ...
        /// <summary>
        /// 移到最后一个字符位置,shift为true则从当前位置选中到最后一个字符位置
        /// </summary>
        ...
        /// <summary>
        /// 移到第一个字符位置,shift为true则从当前位置选中到第一个字符位置
        /// </summary>
        /// <param name="shift"></param>
        ...
        /// </summary>
        /// <param name="shift"></param>
        /// <param name="goToFirstChar"></param>
        ...
        /// <summary>
        /// 设置可见区域字符范围，m_DrawStart和m_DrawEnd
        /// </summary>
        ...
        /// <summary>
        /// 使光标caretRectTrans和文本框m_TextComponent.rectTransform属性保持一致
        /// </summary>
        ...
        /// </summary>
        /// <param name="vbo"></param>
        /// <param name="roundingOffset"></param>
        ...
        /// 验证字符输入是否合法（characterValidation）
        /// </summary>
        ...
        /// <summary>
        /// 根据contentType修改m_InputType，m_KeyboardType，m_CharacterValidation，m_LineType
        /// </summary>
        ...
        /// <summary>
        /// 如果contentType不是allowedContentTypes的其中一个，则设置为自定义模式
        /// </summary>
